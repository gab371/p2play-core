...
3. **Unified Network & Capabilities (`p2play-core`)**: All networking, WebRTC peer management, spectator roles, and voice chat features MUST rely on the [`p2play-core`](g:\prj\sherif\p2play-core\README.md) shared package.
...
- **`p2play-core` Package & Documentation**:
  - [Main README](file:///g:/prj/sherif/p2play-core/README.md)
  - [API Reference](file:///g:/prj/sherif/p2play-core/docs/api-reference.md)
  - [Spectator Mode Guide](file:///g:/prj/sherif/p2play-core/docs/spectator-guide.md)
  - [Voice Chat WebRTC Guide](file:///g:/prj/sherif/p2play-core/docs/voice-chat-guide.md)
- **Hub P2Play Documentation**:
  - [Hub Architecture](file:///g:/prj/sherif/hub-p2play/docs/architecture.md)
  - [Game Mount Contract](file:///g:/prj/sherif/hub-p2play/docs/game-mount-contract.md)
  - [Developer Guide for New Games](file:///g:/prj/sherif/hub-p2play/docs/developer-guide-new-game.md)
- **React & Next.js Best Practices**: [react-best-practices](/.agents/skills/react-best-practices/SKILL.md)
- **React Component Composition**: [composition-patterns](/.agents/skills/composition-patterns/SKILL.md)
- **UI Components & Shadcn**: [shadcn](/.agents/skills/shadcn/SKILL.md)
- **Aesthetic & Design Guidelines**: [web-design-guidelines](/.agents/skills/web-design-guidelines/SKILL.md)
...
1. **File Length & Splitting Rules**
   - [rules/file-length-limits.md](/.agents/skills/project-guidelines/rules/file-length-limits.md)
   - Exceeding 300 lines is an anti-pattern. Learn when and how to split modules.

2. **Architecture & Separation of Concerns Rules**
   - [rules/decoupled-architecture.md](/.agents/skills/project-guidelines/rules/decoupled-architecture.md)
...
3. **React Composition & Component Responsibility**
   - [rules/component-responsibility.md](/.agents/skills/project-guidelines/rules/component-responsibility.md)
...
4. **Pre-Game Configuration (Decks, Extensions & Helper Options)**
   - [rules/pre-game-config.md](/.agents/skills/project-guidelines/rules/pre-game-config.md)
...
5. **Intégration au Hub Persistant & `p2play-core` (hub-p2play)**
   - [rules/hub-integration.md](/.agents/skills/project-guidelines/rules/hub-integration.md)
